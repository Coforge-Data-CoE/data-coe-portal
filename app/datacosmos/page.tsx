  ...
  const carouselPanels = [
    {
      ...
      content: (
        <div
          className="relative w-screen  flex flex-col items-center justify-center overflow-hidden"
          ...
          <div className="relative z-20 flex flex-col items-center justify-center w-full px-4">
            <div className="mb-8 flex justify-center">
              <Image
                ...
                alt="Coforge Data Cosmos Logo"
                width={180}
                height={36}
                className="md:w-[320px]  w-[180px]"
              />
            </div>
            <h1 className="text-xl md:text-3xl xl:text-4xl 2xl:text-6xl font-bold text-white mb-10 text-center drop-shadow-lg">
              A Unified Constellation of Data Excellence
            </h1>
            <p className="text-sm md:text-lg xl:text-2xl text-gray-200 max-w-3xl mx-auto mb-10 text-center drop-shadow-md">
              ...
              Coforge Data Cosmos is AI enabled, foundational innovation
              platform; that we use internally to develop cloud native, domain
              specific solutions that leverage reusable, standard, technology
              based Solutions consisting of our own IP, Accelerators, Agents,
              Utilities, Frameworks, Workflows, Capabilities and optional
              partner products.
            </p>
          </div>
        </div>
      ...
      content: (
        ...
        >
          ...
          <div className="relative z-20 flex flex-col items-center justify-center w-full px-4">
            ...
            <h1 className="text-xl md:text-3xl xl:text-4xl 2xl:text-6xl font-bold text-white mb-8 text-center">
              Powering Transformation with Five Technology Towers
            </h1>
            <div className="text-sm md:text-lg xl:text-2xl text-gray-200 max-w-2xl mx-auto mb-8 text-center">
              ...
              <div className="flex flex-wrap md:flex-nowrap items-center justify-center gap-2 md:gap-4 my-4">
                <div className="flex flex-col items-center md:flex-row md:items-center md:gap-4 w-full">
                  <span className="text-cyan-400 font-bold text-lg md:text-xl xl:text-2xl 2xl:text-3xl">
                    Supernova
                  </span>
                  <span className="hidden md:inline text-cyan-400 text-2xl">
                    &bull;
                  </span>
                </div>
                <div className="flex flex-col items-center md:flex-row md:items-center md:gap-4 w-full">
              ...
              help enterprises evolve from legacy to modern ecosystems and
              unlock the full power of cloud and AI.
            </div>
          </div>
        </div>
      ),
      ...
      content: (
        ...
        >
          ...
          <div className="relative z-20 flex flex-col items-center justify-center w-full px-4">
            ...
            <h1 className="text-xl md:text-3xl xl:text-4xl 2xl:text-6xl  font-bold text-white mb-8 text-center">
              Galaxy Solutions for Every Industry
            </h1>
            <p className="text-sm md:text-lg xl:text-2xl text-gray-200 max-w-2xl mx-auto mb-8 text-center">
              From BFS to Insurance, our domain-led Galaxy offerings build on
              Data Cosmos technologies to bring agility, innovation, and
    ...
    <>
      ...
      <div className="min-h-screen  relative overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "linear-gradient(88deg, #05091a, #162065, #09113a)",
          }}
        >
          ...
          <div className=" mx-auto mt-12">
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
              ...
              <div className="lg:col-span-1">
                <div
                  className="bg-slate-800/40 backdrop-blur-sm border border-slate-700 rounded-lg p-4"
                ...
                >
                  ...
                  <div className="space-y-2">
                    <a
                      href={`${basePath}/galaxies/bfs`}
                      className="w-full text-left p-2 xl:p-3 rounded-lg transition-all duration-200 flex items-center whitespace-normal text-gray-200 hover:bg-[#12182073] hover:text-white border border-slate-500 hover:border-[#86c1ff]"
                    >
                      <i className="ri-bank-line mr-3 text-xs md:text-sm lg:text-sm xl:text-lg"></i>
                      <span className="text-xs md:text-sm lg:text-xs xl:text-sm 2xl:text-lg">
                        Banking & Financial Services
                      </span>
                    </a>
                    <a
                      href={`${basePath}/galaxies/ins`}
                      className="w-full text-left p-2 xl:p-3 rounded-lg transition-all duration-200 flex items-center whitespace-normal text-gray-200 hover:bg-[#12182073] hover:text-white border border-slate-500 hover:border-[#86c1ff]"
                    >
                      <i className="ri-shield-line mr-3 text-xs md:text-sm lg:text-sm xl:text-lg"></i>
                      <span className="text-xs md:text-sm lg:text-xs xl:text-sm 2xl:text-lg">
                        Insurance
                      </span>
                    </a>
                    <a
                      href={`${basePath}/galaxies/tth`}
                      className="w-full text-left p-2 xl:p-3 rounded-lg transition-all duration-200 flex items-center whitespace-normal text-gray-200 hover:bg-[#12182073] hover:text-white border border-slate-500 hover:border-[#86c1ff]"
                    >
                      <i className="ri-plane-line mr-3 text-xs md:text-sm lg:text-sm xl:text-lg"></i>
                      <span className="text-xs md:text-sm lg:text-xs xl:text-sm 2xl:text-lg">
                        Travel, Transport & Hospitality
                      </span>
                    </a>
                    <a
                      href={`${basePath}/galaxies/retail`}
                      className="w-full text-left p-2 xl:p-3 rounded-lg transition-all duration-200 flex items-center whitespace-normal text-gray-200 hover:bg-[#12182073] hover:text-white border border-slate-500 hover:border-[#86c1ff]"
                    >
                      <i className="ri-shopping-cart-line mr-3 text-xs md:text-sm lg:text-sm xl:text-lg"></i>
                      <span className="text-xs md:text-sm lg:text-xs xl:text-sm 2xl:text-lg">
                        Retail, Manufacturing & Consumer Goods
                      </span>
                    </a>
                    <a
                      href={`${basePath}/galaxies/healthcare`}
                      className="w-full text-left p-2 xl:p-3 rounded-lg transition-all duration-200 flex items-center whitespace-normal text-gray-200 hover:bg-[#12182073] hover:text-white border border-slate-500 hover:border-[#86c1ff]"
                    >
                      <i className="ri-heart-pulse-line mr-3 text-xs md:text-sm lg:text-sm xl:text-lg"></i>
                      <span className="text-xs md:text-sm lg:text-xs xl:text-sm 2xl:text-lg">
                        Healthcare & Life Sciences
                      </span>
                    </a>
                    <a
                      href={`${basePath}/galaxies/energy`}
                      className="w-full text-left p-2 xl:p-3 rounded-lg transition-all duration-200 flex items-center whitespace-normal text-gray-200 hover:bg-[#12182073] hover:text-white border border-slate-500 hover:border-[#86c1ff]"
                    >
                      <i className="ri-government-line mr-3 text-xs md:text-sm lg:text-sm xl:text-lg"></i>
                      <span className="text-xs md:text-sm lg:text-xs xl:text-sm 2xl:text-lg">
              ...
              <div className="lg:col-span-3 max-w-7xl w-full mx-auto px-2 sm:px-4 md:px-6 mt-8">
                <div className="grid grid-cols-1 md:grid-cols-5 xl:grid-cols-5 gap-4 mb-6">
                  {cosmosCards.map((card) => (
                    ...
                    >
                      <div className="text-center mb-4">
                        ...
                        <p className="text-xs md:text-sm lg:text-xs xl:text-sm 2xl:text-lg text-blue-300 pt-4 group-hover:text-white transition-colors duration-200">
                          {card.subtitle}
                        </p>
                      </div>
                      <ul className="space-y-1">
                        {card.items.map((item, idx) => (
                          <li key={idx} className="flex items-start">
                            <span className="text-xs md:text-sm lg:text-xs xl:text-sm 2xl:text-lg text-cyan-400 mr-1 transition-colors duration-200 group-hover:text-[#86c1ff]">
                              •
                            </span>
                            <span className="text-xs md:text-sm lg:text-xs xl:text-sm 2xl:text-lg text-gray-200 transition-colors duration-200 group-hover:text-[#86c1ff]">
                              {item}
                            </span>
                          </li>
                        ))}
                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4 mt-6">
                    {(() => {
                      const toolkitIcons = [
                        ...
                        {
                          file: "abc.png",
                          label: "ABC (Audit, Balance & Control) Framework",
                        },
                        {
                          file: "agentic-dq-resolver.png",
                          label: "Agentic DQ Resolver",
                        },
                        {
                          file: "aps.png",
                          label: "Agentic Production Support",
                        },
                        {
                          file: "auto-classifier.png",
                          label: "Auto Classifier",
                        },
                        {
                          file: "backlog-analyzer.png",
                          label: "Backlog Analyzer",
                        },
                        { file: "code-analyzer.png", label: "Code Analyzer" },
                        { file: "data-360.png", label: "Data 360" },
                        {
                          file: "data-governance.png",
                          label: "Data Governance Framework",
                        },
                        {
                          file: "data-ingestion.png",
                          label: "Data Ingestion Framework",
                        },
                        {
                          file: "data-integration.png",
                          label: "Data Integration Framework",
                        },
                        ...
                        {
                          file: "do-analyzer.png",
                          label: "Data Objects Analyzer",
                        },
                        {
                          file: "document-analyzer.png",
                          label: "Document Analyzer",
                        },
                        {
                          file: "file-preload-validation.png",
                          label: "File Preload Validation",
                        },
                        {
                        ...
                        {
                          file: "product-querier.png",
                          label: "Product Querier",
                        },
                        {
                          file: "rrc.png",
                          label: "Report Rationalizer & Converter",
                        },
                        {
                          file: "stdg.png",
                          label: "Synthetic Test Data Generator (STDG) ",
                        },
                        {
                          file: "ticker-analyzer.png",
                          label: "Ticker Analyzer",
                        },
                      ];
                      return toolkitIcons.map(({ file, label }) => {
                        // Split label into first word and the rest
                        const [first, ...rest] = label.split(" ");
                        const htmlLabel = `<span style='color: #F15B40;'>${first}</span>${
                          rest.length
                        ...
                        return (
                          ...
                          >
                            <Image
                              src={`${basePath}/logos/toolkit/${file}`}
                              alt={label}
                              width={36}
                              height={36}
                            />
                            <span
                              className="text-xs xl:text-base font-bold mt-2 text-center w-full break-words"
                ...
                {(() => {
                  const dataPartners = [
                    {
                      name: "Snowflake",
                      logo: `${basePath}/logos/snowflake.png`,
                      width: 110,
                      height: 32,
                    },
                    {
                      name: "Databricks",
                      logo: `${basePath}/logos/data-bricks_white.png`,
                      width: 120,
                      height: 32,
                    },
                    {
                      name: "Snaplogic",
                      logo: `${basePath}/logos/snaplogic_white.png`,
                      width: 120,
                      height: 32,
                    },
                    {
                      name: "dbt",
                      logo: `${basePath}/logos/dbt_white.svg`,
                      width: 60,
                      height: 32,
                    },
                    {
                      name: "Qlik",
                      logo: `${basePath}/logos/qlik.png`,
                      width: 60,
                      height: 32,
                    },
                    {
                      name: "Matillion",
                      logo: `${basePath}/logos/matillion.png`,
                      width: 100,
                      height: 32,
                    },
                    {
                      name: "Coalesce",
                      logo: `${basePath}/logos/coalesce.png`,
                      width: 120,
                      height: 32,
                    },
                  ];
                    ...
                    <div className="bg-slate-800/40 backdrop-blur-sm border border-slate-500 rounded-lg p-4 mb-6">
                      ...
                      <div className="grid grid-cols-2 md:grid-cols-7 gap-4">
                        {dataPartners.map((partner) => (
                          <div
                            key={partner.name}
                            className="bg-[#12182073] rounded-lg p-3 hover:bg-blue-500/50 border border-slate-500 transition-all duration-200 flex flex-col items-center justify-between h-24"
                          >
